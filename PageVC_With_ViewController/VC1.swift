...
class VC1: UIViewController
{
    ...
    ///Static Array
    let staticArray : [String] = ["Alabama", "Arkansas","American Samoa","Arizona","California","Colorado","Connecticut","District of Columbia","Delaware","Florida","Georgia","Guam","Hawaii","Iowa","Idaho","Illinois","Indiana"]
